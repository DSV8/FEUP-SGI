...
class MyApp  {
    ...
    initCameras() {
        ...
        // Create secondary perspective camera
        const perspective2 = new THREE.PerspectiveCamera( 55, aspect, 0.1, 1750 )
        perspective2.position.set(-3,13,-10)
        ...
        orthoLeft.position.set(-this.frustumSize /4,5,0) 
        ...
        orthoRight.position.set(this.frustumSize /4,5,0)
        ...
        orthoTop.position.set(0, this.frustumSize / 2, 0) 
        ...
        orthoFront.position.set(0,5, this.frustumSize /4) 
        ...
        orthoBack.position.set(0, 5, -this.frustumSize /4)
    ...
    updateCameraIfRequired() {
        ...
        if (this.lastCameraName !== this.activeCameraName) {
            ...
            if (this.controls === null) {
                ...
                this.controls.target.set(0, 5, 0); // target the scene origin   
