...
class MySceneData {
  ...
  constructor() {
    ...
    */
    ...
    this.descriptors["nurbs"] = [
      ...
      { name: "controlpoints", type: "list", listOf: "point" }
    ]
    ...
    this.primitiveIds = ["cylinder", "rectangle", "triangle", "sphere", "nurbs", "box", "model3d", "skybox", "polygon", "track"]
  ...
  createEmptyNode(id, isLod = false, mindist = 0) {
    ...
    obj = { id: id, transformations: [], materialIds: [], children: [], loaded: false, type: type, castshadows: false, receiveshadows: false, mindist: mindist };
    this.addNode(obj);
    return obj;
  }
  ...
  async onLoadFinished(app, contents) {
    ...
    var filteredObjects = this.objects.filter(obj => obj.subtype === "sphere" || obj.subtype === "cylinder");

    // check phi and theta values for sphere and cylinder
