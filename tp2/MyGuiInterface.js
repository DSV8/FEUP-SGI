...
class MyGuiInterface  {
     ...
     */
    init() {    
        const wireframeControl = this.datgui.add({ wireframe: false }, 'wireframe').name('Show Wireframe');
        wireframeControl.onChange((value) => {
            // Call the function to update all materials when the checkbox changes
